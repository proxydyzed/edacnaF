// Minimal dependency, so that you can yank this file out easily.
...
// Everything in this function uses little-endian, unless otherwise noted so.
export function unlock(buffer) {
  ...
  // return the original buffer (modifier in place)
  return buffer;
}
